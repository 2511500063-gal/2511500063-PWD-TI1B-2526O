...
/* ============================================================
   BAGIAN 1 : FORM BIODATA MAHASISWA (section #biodata)
   ============================================================ */
...
/* === Hanya huruf + spasi untuk beberapa field === */
...
if (mysqli_stmt_execute($stmt_bio)) {
  ...
  // isi session biodata untuk section "Tentang Saya"
  $_SESSION['biodata'] = [
    'nim'     => $nim,
    'nama'    => $nama_lengkap,
    'tempat'  => $tempat_lahir,
  ...
  // tampilkan error MySQL supaya tahu persis salah di mana
...
/* ============================================================
   BAGIAN 2 : FORM KONTAK (section #contact)
   (kalau memang mau dipakai dari form lain)
   ============================================================ */

#cek method form lagi kalau dipanggil dari contact
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
  $_SESSION['flash_error'] = 'Akses tidak valid.';
  redirect_ke('index.php#contact');
}
