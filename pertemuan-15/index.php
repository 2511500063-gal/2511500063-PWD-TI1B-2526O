...
<main>
  ...
  <section id="biodata">
    ...
    <?php if (!empty($flash_sukses_bio)): ?>
      <div class="alert-sukses"><?= $flash_sukses_bio; ?></div>
    <?php endif; ?>
  ...
  <section id="contact">
    ...
    <?php if (!empty($flash_sukses)): ?>
      <div class="alert-sukses"><?= $flash_sukses; ?></div>
    <?php endif; ?>
